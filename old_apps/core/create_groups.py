...
from old_apps.automation.models import AutomatedSystem
from old_apps.objects.models import Object
from old_apps.participants.models import Participant, Project, VendorProduct
