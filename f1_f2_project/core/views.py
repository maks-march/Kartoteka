...
def export_import_page(request):
    ...
    return render(request, 'core/export_import.html')
...
def ownership_view(request):
    ...
    return render(request, 'core/ownership_tree.html', {'groups': groups})
...
def object_create_view(request):
    ...
    return render(request, 'core/object_form.html', {
        'form': form,
...
def participant_create_view(request):
    ...
    return render(request, 'core/participant_form.html', {
        'form': form,
...
def participant_delete_view(request, pk):
    ...
    return render(request, 'core/participant_confirm_delete.html', {'object': participant})
...
def system_list_view(request):
    ...
    return render(request, 'core/system_list.html', context)
...
def system_create_view(request):
    ...
    return render(request, 'core/system_form.html', {
        'form': form,
...
def system_delete_view(request, pk):
    ...
    return render(request, 'core/system_confirm_delete.html', {'object': system})
...
def class_hierarchy_view(request):
    ...
    return render(request, 'core/class_hierarchy.html', context)
...
def vendor_product_list_view(request):
    ...
    return render(request, 'core/vendor_products_list.html', context)
...
def vendor_product_detail_view(request, product_id):
    ...
    return render(request, 'core/vendor_product_detail.html', context)
...
def participants_by_type_view(request):
    ...
    return render(request, 'core/participants_by_type.html', context)
...
def automation_report_view(request):
    ...
    return render(request, 'core/automation_report.html', context)
...
def graph_view(request):
    ...
    if cached_data:
        ...
        return render(request, 'core/graph.html', cached_data)
...
def graph_view_simple(request):
    ...
    return render(request, 'core/graph.html', {'has_data': True})
...
def object_history_view(request, pk):
    ...
    return render(request, 'core/audit_history.html', {
        'object': obj,
        'history': history,
...
def legal_entity_detail_view(request, pk):
    ...
    return render(request, 'core/legal_entity_detail.html', context)
...
def db_stats(request):
    ...
    return render(request, 'core/db_stats.html', {'stats': stats_data})
