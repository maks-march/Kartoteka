...
class ObjectAdmin(admin.ModelAdmin):
    ...
    list_display = [
        "object_name", "object_class", "hierarchy_level", "parent_object",
        "category", "owner_entity", "status", "city", "created_at",
    ]
    list_filter = ["hierarchy_level", "status", "is_reconstructed", "created_at"]
    search_fields = ["object_name", "object_short_name", "object_law_name", "city", "title", "licensor"]
    raw_id_fields = ["parent_object", "category", "owner_entity"]
...
class ObjectSystemAdmin(admin.ModelAdmin):
    ...
    list_display = ["object", "system", "status", "implementation_date", "implementor", "supplier"]
    list_filter = ["status", "implementation_date"]
    raw_id_fields = ["object", "system", "implementor", "supplier"]
